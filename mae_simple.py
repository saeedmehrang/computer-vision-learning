...
class SinusoidalPositionalEncoding(nn.Module):
    ...
    Calculated based on index and dimension of the embedding. This approach
    is inherently robust to varying input sequence lengths (resolution changes).
    """
    def __init__(self, num_patches, embed_dim):
        ...
        # Calculate the denominator's reciprocal (which is the frequency multiplier)
        # Formula: div_term = 1 / (10000 ^ (2k / embed_dim)), where 2k is the index in the embedding.
        div_term = torch.exp(
        ...
        # Apply sine to even indices (2k)
        pe[:, 0::2] = torch.sin(position * div_term)
        # Apply cosine to odd indices (2k + 1)
